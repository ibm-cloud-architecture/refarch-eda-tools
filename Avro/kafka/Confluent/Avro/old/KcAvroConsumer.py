...
class KafkaAvroConsumer:
    ...
    def __init__(self, topic_name = "kafka-avro-producer", groupID = 'KafkaAvroConsumer', autocommit = True):
    ...
    def printConsumerConfiguration(self,options):
        ...
        print('[KafkaAvroConsumer] - Schema Registry url:   {}'.format(options['schema.registry.url'].split('@')[-1]))
        if (os.getenv('KAFKA_PASSWORD','') != ''):
            # Obfuscate password
    ...
    def traceResponse(self, msg):
        print('[KafkaAvroConsumer] - Topic {} partition [{}] at offset: {}\n\tkey: {}\n\tvalue: {}'
